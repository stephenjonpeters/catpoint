...
public class FakeSecurityRepository implements SecurityRepository{
    ...
    private static final Preferences prefs = Preferences.userNodeForPackage(FakeSecurityRepository.class);
    private static final Gson gson = new Gson(); //used to serialize objects into JSON
    private Set<Sensor> sensors;
    private AlarmStatus alarmStatus;
    private ArmStatus armingStatus;
    ...
    public FakeSecurityRepository() {
        ...
        armingStatus = ArmStatus.valueOf(prefs.get(ARMING_STATUS, ArmStatus.DISARMED.toString()));
